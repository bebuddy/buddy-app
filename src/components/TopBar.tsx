  ...
  return (
    <>
      ...
      <div
        aria-hidden
        className="w-full"
        style={{ height: "calc(57px + var(--safe-area-inset-top))" }}
      />
      ...
      >
        <div className="px-6 pb-[14px] flex items-center justify-between" style={{ paddingTop: "calc(var(--safe-area-inset-top) + 8px)" }}>
          <Image
            src="/logo.svg"
            alt="벗 로고"
            width={40}
